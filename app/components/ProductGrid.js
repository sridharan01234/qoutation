    ...
    >
        ...
        {isHovered && (
          <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-20">
            <button
              ...
              className="px-4 py-2 bg-white text-gray-900 rounded-md shadow-md hover:bg-gray-100 transition-colors duration-200"
            >
              Quick View
            </button>
          </div>
      ...
      <div className="p-4">
        ...
        <button
          ...
          className={`mt-4 w-full px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200
            ${product.stock > 0 
